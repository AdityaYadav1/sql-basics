...
SELECT customers.customer_name, customers.customer_phone FROM customers LEFT JOIN orders ON customers.customer_id = orders.customer_id WHERE year(orders.order_date) = '2014';
